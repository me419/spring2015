...
NanoSatisfi_MAG3110::NanoSatisfi_MAG3110()
{
    ...
    */                        
    ...
    mag_x_scale= 1.0/(-754 + 1046); //offset scale factor: 1.0/(max_x - min_x)
    mag_y_scale= 1.0/(686 - 341);    //offset scale factor: 1.0/(max_y - min_y)
    mag_z_scale= 1.0/(-1452 + 1567);  //offset scale factor: 1.0/(max_z - min_z)
}
