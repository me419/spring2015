...
NanoSatisfi_MAG3110::NanoSatisfi_MAG3110()
{
    ...
    */                        
    ...
    mag_x_scale= 1.0/(-711 + 1114); //offset scale factor: 1.0/(max_x - min_x)
    mag_y_scale= 1.0/(692 - 278);    //offset scale factor: 1.0/(max_y - min_y)
    mag_z_scale= 1.0/(-1330 + 1434);  //offset scale factor: 1.0/(max_z - min_z)
}
